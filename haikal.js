                ...
                "requestPaymentMessage": {
                    ...
                    noteMessage: {
                        extendedTextMessage: {
                            ...
                            `
Script *Ryoo* bisa di dapatkan dengan mengklik tautan di bawah ini 
...
case "halo":
       ...
       case "hello":
       case "hallo":
       var mnn = fs.readFileSync('./baseikal/video/menu.gif')
       conn.sendMessage(from, { video: mnn, caption: `hai juga kak ${pushname}👋 selamat ${salam}\n\nsemoga hari kaka indah😆`, gifPlayback: true }, { quoted: ftoko })
       break
//=================================================
case 'unbanned': {
if (!isCreator) return
